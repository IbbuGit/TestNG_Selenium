...
public class AdminTransaction_ACH_RCCPayments_RCCPaymentsBeforeDEFOriginationFile_PO extends BasePage {

	/*
	 * Constructor
	 */

	public AdminTransaction_ACH_RCCPayments_RCCPaymentsBeforeDEFOriginationFile_PO(WebDriver _driver, ExtentTest report) {
	...
	private WebElement RCCPaymentsBeforeDEFOriginationFile_pageHeader;
	...
	public String get_RCCPaymentsBeforeDEFOriginationFile_pageHeader(String TestData_pageHeader) {
		return doIT(RCCPaymentsBeforeDEFOriginationFile_pageHeader, TestData_pageHeader);
	}
